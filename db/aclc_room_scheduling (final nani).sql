...
CREATE TABLE `class_tb` (
  ...
  `class_department` int(11) NOT NULL,
...
(4, '08:00', '09:00', 'Monday', '1st', '2023-2024', 1, 2, 4, 12),
...
(4, 'Calculus 1', '3', 'MATH6100', 4, 'Lecture'),
...
--
ALTER TABLE `class_tb`
  ADD CONSTRAINT `class_tb_ibfk_1` FOREIGN KEY (`class_department`) REFERENCES `department_tb` (`department_id`);

--
-- Constraints for table `schedule_tb`
--
ALTER TABLE `schedule_tb`
  ADD CONSTRAINT `schedule_tb_ibfk_1` FOREIGN KEY (`room_id`) REFERENCES `room_tb` (`room_id`),
  ADD CONSTRAINT `schedule_tb_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teacher_tb` (`teacher_id`),
  ADD CONSTRAINT `schedule_tb_ibfk_3` FOREIGN KEY (`subject_id`) REFERENCES `subject_tb` (`subject_id`),
  ADD CONSTRAINT `schedule_tb_ibfk_4` FOREIGN KEY (`class_id`) REFERENCES `class_tb` (`class_id`);

--
-- Constraints for table `subject_tb`
--
ALTER TABLE `subject_tb`
  ADD CONSTRAINT `subject_tb_ibfk_1` FOREIGN KEY (`subject_department`) REFERENCES `department_tb` (`department_id`);

--
-- Constraints for table `teacher_tb`
--
ALTER TABLE `teacher_tb`
  ADD CONSTRAINT `teacher_tb_ibfk_1` FOREIGN KEY (`teacher_department`) REFERENCES `department_tb` (`department_id`),
  ADD CONSTRAINT `teacher_tb_ibfk_2` FOREIGN KEY (`SD_id`) REFERENCES `sd_tb` (`SD_id`);
COMMIT;
