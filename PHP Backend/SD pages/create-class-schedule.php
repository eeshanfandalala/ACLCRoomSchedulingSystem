...
<body>
    <div>
        <h4>Choose if College or SHS</h4>
            ...
            ?>
                <form action="?action=form3" method="post">
                    ...
                    <datalist id="subject-list">
                        ...
                        ?>
                            <option value="<?php echo $rowsubjects['subject_id'] . '|' . $rowsubjects['subject_name']; ?>"><?php echo $rowsubjects['subject_name']; ?></option>
                        <?php
                        }
                        $findsubjects->free_result();
                        ?>
                    </datalist>
                    <input type="text" name="subject" id="selected-subject" list="subject-list" placeholder="Choose a subject..." value="<?php if (isset($_POST['sub3'])) : echo $_POST['subject'];
                                                                                                                                            endif; ?>" required>
                    ...
                    <datalist id="teacher-list">
                        ...
                        ?>
                            <option value="<?php echo $rowTeacher['teacher_id']  . '|' . $rowTeacher['teacher_name']; ?>"><?php echo $rowTeacher['teacher_name']; ?></option>
                        <?php
                        }
                        ?>
                    </datalist>
                    <input type="text" name="teacher" id="selected-teacher" list="teacher-list" placeholder="Choose a teacher..." value="<?php if (isset($_POST['sub3']) || isset($_POST['sub4'])) : echo $_POST['teacher'];
                                                                                                                                            endif; ?>" required>
                                    ...
                                    <tr>
                                        <td>
                                            <datalist id="room-list">
                                                ...
                                                ?>
                                                    <option value="<?php echo $rowRoom['room_id'] . '|' . $rowRoom['room_name']; ?>"><?php echo $rowRoom['room_name']; ?></option>
                                                <?php
                                                }
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($rowreturnValOfClassExistiongSubjectOfTheSYandSem['subject_name']); ?></td>
                                    <td><?php echo htmlspecialchars($schedule_time['start']) . "<br>" . htmlspecialchars($schedule_time['end']); ?></td>
                                    <td><?php echo htmlspecialchars($rowreturnValOfClassExistiongSubjectOfTheSYandSem['room_name']); ?></td>
                                    <td><?php echo htmlspecialchars($rowreturnValOfClassExistiongSubjectOfTheSYandSem['teacher_name']); ?></td>
