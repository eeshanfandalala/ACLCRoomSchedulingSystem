    ...
    <body>
        <div>
            <form method="post" enctype="multipart/form-data">
                ...
                <div>
                    <input type="text" name="SD_lastname" id="SD_lastname" value="<?php echo $row['SD_lastname']; ?>" disabled placeholder="name">
                    <input type="text" name="SD_firstname" id="SD_firstname" value="<?php echo $row['SD_firstname']; ?>" disabled placeholder="name">
                </div>
                <div>
